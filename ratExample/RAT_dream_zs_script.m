...
ARGS_1_1.modout = coder.typeof('X',[1 Inf],[0 1]);
...
ARGS_1_2_problemDef.contrastBacks = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.contrastBacksType = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.TF = coder.typeof('X',[1 Inf],[0 1]);
ARGS_1_2_problemDef.resample = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.dataPresent = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.numberOfContrasts = coder.typeof(0);
ARGS_1_2_problemDef.geometry = coder.typeof('X',[1 Inf],[0 1]);
ARGS_1_2_problemDef.contrastShifts = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.contrastScales = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.contrastNbas = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.contrastNbss = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.contrastRes = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.backs = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.shifts = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.sf = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.nba = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.nbs = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.res = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.params = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_problemDef.numberOfLayers = coder.typeof(0);
ARGS_1_2_problemDef.modelType = coder.typeof('X',[1 Inf],[0 1]);
ARGS_1_2_problemDef.contrastCustomFiles = coder.typeof(0,[1 Inf],[0 1]);
...
ARGS_1_2_controls_checks.params_fitYesNo = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_controls_checks.backs_fitYesNo = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_controls_checks.shifts_fitYesNo = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_controls_checks.scales_fitYesNo = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_controls_checks.nbairs_fitYesNo = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_controls_checks.nbsubs_fitYesNo = coder.typeof(0,[1 Inf],[0 1]);
ARGS_1_2_controls_checks.resol_fitYesNo = coder.typeof(0,[1 Inf],[0 1]);
...
%% Invoke MATLAB Coder.
codegen -config cfg RAT_dream_zs_compile -args ARGS{1}
